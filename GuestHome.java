...
public class GuestHome extends AppCompatActivity {
    ...
    private void updateNavHeader() {
        ...
        TextView navfullname = headerview.findViewById(R.id.phone);

        ImageView navphoto = headerview.findViewById(R.id.image);
        navfullname.setText(currentUser.getPhoneNumber());
    }
